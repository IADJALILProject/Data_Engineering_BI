...
def ingestion_step(raw_data_path, processed_data_path):
    ...
    return processed_data_path  # Retourne le chemin des fichiers nettoyés
...
def transformation_step(processed_data_path, transformed_data_path):
    ...
    return transformed_data_path  # Retourne le chemin transformé

# Étape 3 : Sauvegarde dans PostgreSQL
@task
...
def full_data_pipeline():
    """
    Orchestration complète des étapes : ingestion, transformation, stockage et monitoring.
    """
    # Paramètres
